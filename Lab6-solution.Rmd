...
1.  What are the dimensions of the Denny's dataset? 1643 and 6
...
2.  What are the dimensions of the La Quinta's dataset? 
    What does each row in the dataset represent? culome and
    What are the variables?6 columns and  909 rows
